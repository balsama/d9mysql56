 ...
 * @endcode
 */
$settings['hash_salt'] = '7o4lrb-28j2Ac4OTtBGhnrUnUbeU9VwZ5sOjtxvQeWPRdHteilXMtpYVGuNj-mIDO1ojY1MedQ';
...
// Acquia Hosting database settings include.
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/nightlyworkflow/nightlyworkflow-settings.inc';
}

$settings['config_sync_directory'] = '../config_sync/';
unset($config_directories);
